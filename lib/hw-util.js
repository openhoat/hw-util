...
that = {
  ...
  loadConfig: function (configDir, defaultConfigName, depth, baseDir) {
    var path = require('path')
      , fs = require('fs')
  ...
  parseArgs: function (args, specs) {
    var argsArray, result, key, spec, i, arg, j, done;

    function argMatches(arg, spec) {
      return (!spec.objectType && typeof arg === spec.type) ||
        (spec.objectType && typeof arg === 'object' && arg instanceof spec.objectType);
    }
